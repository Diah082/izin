...
### INSTALL SCRIPT 
<pre><code>apt update -y && apt upgrade -y && apt install -y wget curl screen git && wget -q https://raw.githubusercontent.com/Diah082/vip/main/setup.sh && chmod +x setup.sh && screen -S install ./setup.sh
</code></pre>
